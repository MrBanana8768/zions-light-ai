...
| `:v3.1.9.4-cu12` | The same image as `:v3.1.9.5-cu12`, so NOT a rollback target from it; for rollback see [RUNPOD_DEPLOY.md](RUNPOD_DEPLOY.md#upgrading-within-v319x-and-rolling-back) |
